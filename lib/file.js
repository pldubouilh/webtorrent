...
File.prototype.createReadStream = function (opts) {
  ...
  self._torrent._selectPieces(fileStream._startPiece, fileStream._endPiece, true, function () {
    fileStream._notify()
  })
  eos(fileStream, function () {
    if (self._destroyed) return
    if (!self._torrent.destroyed) {
      self._torrent._deselectPieces(fileStream._startPiece, fileStream._endPiece, true)
    }
  })
  return fileStream
}
